...
function emailCheck(email){
    ...
    if (email.includes(`@`)){
        ...
        return "must provide a valide email address"
    }
}
let check = emailCheck(`rolaalasmar@gmail.com`)
console.log(check)

////////////////// PROBLEM 19 ////////////////////
/*
  Write a function, naming it whatever you believe to be appropriate, that buys as many chocolate frogs as possible with a 
  certain amount of gold. Each chocolate frog costs 3 gold. Your function should take in a single parameter, which is the amount of gold you are 
...
let totalFrogs = chocolateFrogs(25)
...
function chocolateFrogs2(gold2){
    frogs2 = gold2/3
    return Math.floor(frogs2)
}
let totalFrogs2 = chocolateFrogs2(25)
...
/*
  ...
  ascending order. The function should return true, if it is sorted in ascending order, false if it is not. Create a variable, `arrayIsAscending` and 
...
let determineAscending = ascendingOrder(sampleArray)
console.log(determineAscending)
